      ...
      {talentUser && (
        <div className='border-[1px] border-green-200 p-4 h-[100%] w-[90%] rounded-md mx-auto'>
          ...
          <h3 className='text-center text-md font-serif mt-5 mb-20'>
            This is an experimental feature that calculates rank percentiles
            base on your years of experience, skills, and collaborations
          </h3>
          ...
          <h4 className='text-center text-md '>
            Please before you click on test make sure to add your github social
            account
          </h4>
